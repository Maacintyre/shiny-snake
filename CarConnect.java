...
public class CarConnect {
  ...
  public void firstTest() {
    ...
    BasicCar testCar1 = new BasicCar(1, "lime", 0.5f, 0.7f, 0.9f);
    ...
    System.out.println("testCar1 longitude: " + testCar1.getLongitude());
    System.out.println("testCar1 latitude: " + testCar1.getLatitude());
    testCar1.drive(0);
    System.out.println("");

    System.out.println("Creating smartCar1: ");
    SmartCar testCar2 = new SmartCar(2, "and coconut", 0.5f, 0.7f, 0.9f);
    ...
    System.out.println("testCar2 longitude: " + testCar2.getLongitude());
    System.out.println("testCar2 latitude: " + testCar2.getLatitude());
    testCar2.drive(0);
    testCar2.setSpeed(0.0f);
    testCar2.setAcceleration(0.0f);
    testCar2.send();
